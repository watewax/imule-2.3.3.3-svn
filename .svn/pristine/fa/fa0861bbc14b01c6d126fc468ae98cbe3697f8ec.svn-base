README for iMule on the Mac
===========================

Installation:
-------------
Just drag the iMule application to a folder of your choice (e.g., /Applications). To start iMule, double-click the application icon.


Documentation and help resources:
---------------------------------
The heart of iMule's documentation is the aMule Wiki, which you can find at http://wiki.amule.org/index.php/Main_Page. We suggest that you start with the Getting Started Guide (http://wiki.amule.org/index.php/Getting_Started) and the aMule FAQ (http://wiki.amule.org/index.php/FAQ_aMule). These pages should give you a good idea of how to setup and use aMule.

If you run into any problems you can drop by at the iMule forum (http://forum.imule.org). A lot of questions have already been answered there, so it is always a good idea to start by searching the forum for your particular problem. If you don't find an answer to your problem you can post your problem on the forum and we will do our best to help you out.
...
-----------------------------------------
iMule contains a lot of features that are only accessible through pop-up menus, which you invoke by right-clicking a certain item. For instance, if you want to pause or cancel a download, change the upload or download priority of a file, see file details, etc. you need to do this via a right-click.
...
If you want to discover all of iMule's hidden functionalities just try to control-click everything that moves.  
...
-------------------------------
There are basically four ways to download files with iMule:

(1) Search for files using iMule's search dialog and double click those search results that you want to download.

(2) Copy ed2k-links from a web page into the "ED2K-Link Handler" field at the bottom of the search window of iMule and press the commit button. If the ed2k-link is longer than that text field is wide you need to make the iMule window wider until the link fits completely into the field (you can make the iMule window wider than your screen if necessary). We are working on eliminating this issue.

(3) Import ed2k-links directly from your browser into iMule. See http://forum.imule.org/thread.php?threadid=5679 for more details.

(4) Use a text editor (e.g. TextEdit) to paste ed2k-links into a "ED2Links" file inside "~/Library/Application Support/iMule/" and iMule will automatically import the links.


Setting up iMule's video preview feature:
-----------------------------------------
...
Getting up-to-date snapshot builds of iMule:
--------------------------------------------
