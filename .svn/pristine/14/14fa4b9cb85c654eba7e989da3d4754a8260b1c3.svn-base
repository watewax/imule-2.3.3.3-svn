...
wxString                WRAPC(GetClientFullInfo)
wxString                WRAPC(GetClientShortInfo)
...
const CI2PAddress &		WRAPC(GetTCPDest)
const CI2PAddress &             WRAPC(GetUDPDest)
float				WRAPC(GetKBpsDown)
float				WRAPC(GetAvgKBpsDown)
float				WRAPC(GetAvgKBpsUp)
...
const CI2PAddress &		WRAPC(GetServerIP)
