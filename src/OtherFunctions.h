...
{
public:
        static wxString GetConfigDir(const wxString &configFile = wxT("imule.conf"));
        static wxString GetExecutableDir();
        static bool     IsNomad();
        static void     MakeNomad();
        static void     MakePerUserConfig();
private:
        static wxString startDir  ;
        static wxString configDir ;
        static CPath    nomadFile ;
};
