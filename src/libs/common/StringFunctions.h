...
inline Unicode2CharBuf unicode2char(const wxString& x)  { return unicode2char((const wxChar *) x.c_str()); }
...
inline Unicode2CharBuf unicode2UTF8(const wxString& x)  { return unicode2UTF8((const wxChar *) x.c_str()); }
inline Char2UnicodeBuf UTF82unicode(const char* x)	{ return wxConvUTF8.cMB2WX(x); }

inline const wxCharBuffer char2UTF8(const char *x)	{ return unicode2UTF8((const wxChar *)char2unicode(x)); }
inline const wxCharBuffer UTF82char(const char *x)	{ return unicode2char((const wxChar *)UTF82unicode(x)); }

inline Unicode2CharBuf filename2char(const wxChar* x)   { return wxConvFile.cWC2MB(x); }
inline Unicode2CharBuf filename2char(const wxString& x) { return filename2char((const wxChar *) x.c_str()); }
