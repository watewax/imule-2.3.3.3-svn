...
void CamuleDlg::OnAboutButton(wxCommandEvent& WXUNUSED(ev))
{
        ...
        msg << wxT ( "\n\n" ) << _ (
                    ...
                    " Website: http://www.imule.i2p \n"
                    " Forum: http://forum.i2p \n"
                    " FAQ: http://www.imule.i2p/trac \n\n"
                    " Contact: mkvore@mail.i2p (administrative issues) \n"
                    " Copyright (C) 2003-2006 imule Team \n\n"
                    " Part of imule is based on \n"
...
{
#ifndef __WXMSW__
        // Evil Hack: check if the mouse is inside the window. Removed my mkvore to check what happens.
...
bool CamuleDlg::Check_and_Init_Skin()
{
        ...
        wxString userDir(JoinPaths(CConfigDir::GetConfigDir(), wxT("skins")) + wxFileName::GetPathSeparator());
